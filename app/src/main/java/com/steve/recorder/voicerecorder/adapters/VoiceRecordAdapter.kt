package com.steve.recorder.voicerecorder.adapters
...
import com.steve.recorder.databinding.VoiceItemBinding
import com.steve.recorder.voicerecorder.data.Record
import java.io.File
import java.text.SimpleDateFormat
import java.util.*

class VoiceRecordAdapter : ListAdapter<Record, VoiceRecordAdapter.MyViewHolder>(VoiceRecorderDiffUtilCallBack()) {
